...
{
public:
    explicit RuntimeMultiKeyEd25519Provider(std::vector<std::pair<std::string, std::array<unsigned char, 64U>>> keys);
...
private:
    std::unordered_map<std::string, std::array<unsigned char, 64U>> secrets_{};
};
