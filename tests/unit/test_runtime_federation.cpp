...
TEST_CASE("Runtime federation config parses validated transaction limits", "[federation][runtime]")
{
    // Given
...
TEST_CASE("Runtime federation summary exposes bounded operational values", "[federation][runtime]")
{
    // Given
