...
constexpr auto version = std::string_view{"0.9.15"};
    ...
    merovingian::net::ShutdownSignal& shutdown) -> merovingian::homeserver::HttpServeStats
{
    ...
    // threads aren't wasted ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â sync long-polls are offloaded to sync_pool below.
