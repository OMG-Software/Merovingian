...
| Discovery | `GET /_matrix/client/unstable/org.matrix.msc2965/auth_metadata` | `partial` | Returns 404 M_UNRECOGNIZED before the access-token gate. Cinny probes this for OIDC support; 404 lets it fall back gracefully instead of producing a misleading 401. |
