...
| Rooms | `POST /_matrix/client/v3/createRoom` | `spec-covered` | Local room creation works through the client listener and SQLite-persisted rooms survive restart. v1.18 fixture covers createRoom with name, visibility, and unauthenticated rejection. Needs full create-room auth events and conformance fixtures. |
