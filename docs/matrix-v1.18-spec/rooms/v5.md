...
This room version builds on version 4[version 4](/v1.18/rooms/v4/) while enforcing signing
...
redactions[redactions](/v1.18/rooms/v5/#redactions) section below for a full overview of the algorithm.
...
4[room version
4](/v1.18/rooms/v4/), ensuring that signing key validity is respected.
