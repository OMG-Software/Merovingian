...
This room version builds on version 7[version 7](/v1.18/rooms/v7/) to introduce a new
...
join events. Room version 9[Room version 9](/v1.18/rooms/v9/) should be preferred over v8 when
creating rooms.
...
Client-Server API[Client-Server API](/v1.18/client-server-api/#restricted-rooms).

Clients which implement the redaction algorithm locally should refer to the
redactions[redactions](/v1.18/rooms/v8/#redactions) section below for a full overview.
...
Room version 9[Room version 9](/v1.18/rooms/v9/) adds additional cases of protected properties for behaviour
...
Room version 7[Room version 7](/v1.18/rooms/v7/).
...
See above[See above](/v1.18/rooms/v8/#redactions).
