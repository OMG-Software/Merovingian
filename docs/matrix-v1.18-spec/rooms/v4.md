...
This room version builds on version 3[version 3](/v1.18/rooms/v3/) using a different
...
redaction algorithm locally should refer to the redactions[redactions](/v1.18/rooms/v4/#redactions)
...
3[room version
3](/v1.18/rooms/v3/), however using URL-safe base64 to generate the event ID.
...
The event format is the same as room version 3[room version 3](/v1.18/rooms/v3/#event-format),
