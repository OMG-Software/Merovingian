...
This room version builds on version 5[version 5](/v1.18/rooms/v5/) while changing various
...
redactions[redactions](/v1.18/rooms/v6/#redactions) section below for a full overview of the algorithm.
...
in room version 5[room version 5](/v1.18/rooms/v5/).

### Redactions

See above[See above](/v1.18/rooms/v6/#redactions).

### Event format

**[New in this version]** Through enforcement of Canonical JSON[Canonical JSON](/v1.18/rooms/v6/#canonical-json),
...
**[New in this version]** Additionally, the authorization rules for events of
...
the Handling Redactions[Handling Redactions](/v1.18/rooms/v6/#handling-redactions) section.
