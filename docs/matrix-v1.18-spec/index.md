...
Proposals for Spec Changes to Matrix[Proposals for Spec Changes to Matrix](/v1.18/proposals/).
...
- Client-Server API[Client-Server API](/v1.18/client-server-api/)

- Server-Server API[Server-Server API](/v1.18/server-server-api/)

- Application Service API[Application Service API](/v1.18/application-service-api/)

- Identity Service API[Identity Service API](/v1.18/identity-service-api/)

- Push Gateway API[Push Gateway API](/v1.18/push-gateway-api/)

- Room Versions[Room Versions](/v1.18/rooms/)

- Olm & Megolm[Olm & Megolm](/v1.18/olm-megolm/)

- Appendices[Appendices](/v1.18/appendices/)
...
section the overall architecture[overall architecture](/v1.18/#architecture).

The Matrix API Viewer[Matrix API Viewer](https://matrix.org/docs/api/) is useful for
...
RFC 2119[RFC 2119](https://datatracker.ietf.org/doc/html/rfc2119).

Some entire sections of the specification might be optional depending on the
circumstances. For example, the
modules of the client-server API[modules of the client-server API](/v1.18/client-server-api/#modules)
...
appendices[‘Identifier Grammar’ in the
appendices](/v1.18/appendices/#identifier-grammar) for full details of the
...
See MSC2801[MSC2801](https://github.com/matrix-org/matrix-spec-proposals/blob/main/proposals/2801-untrusted-event-data.md) for more
...
ECMAScript[ECMAScript](https://tc39.es/ecma262/multipage/numbers-and-dates.html#sec-time-values-and-time-range).
Throughout the specification this may be referred to as POSIX,
Unix[Unix](https://en.wikipedia.org/wiki/Unix_time), or just “time in
milliseconds”.
...
about this is described in the deprecation policy[deprecation policy](/v1.18/#deprecation-policy)
below.
...
Matrix 1.0[Matrix 1.0](https://matrix.org/blog/2019/06/11/introducing-matrix-1-0-and-the-matrix-org-foundation/)
did not correspond directly to a specification version; instead, it was based on
the following versions for the individual APIs:| API/Specification | Version |
| --- | --- |
...
`GET /_matrix/client/versions`[GET /_matrix/client/versions](/v1.18/client-server-api/#get_matrixclientversions)
response.

## License

The Matrix specification is licensed under the Apache License, Version
2.0[Apache License, Version
