...
Proposals for Spec Changes to Matrix[Proposals for Spec Changes to Matrix](/v1.19/proposals/).
...
- Client-Server API[Client-Server API](/v1.19/client-server-api/)

- Server-Server API[Server-Server API](/v1.19/server-server-api/)

- Application Service API[Application Service API](/v1.19/application-service-api/)

- Identity Service API[Identity Service API](/v1.19/identity-service-api/)

- Push Gateway API[Push Gateway API](/v1.19/push-gateway-api/)

- Room Versions[Room Versions](/v1.19/rooms/)

- Olm & Megolm[Olm & Megolm](/v1.19/olm-megolm/)

- Appendices[Appendices](/v1.19/appendices/)
...
section the overall architecture[overall architecture](/v1.19/#architecture).
...
modules of the client-server API[modules of the client-server API](/v1.19/client-server-api/#modules)
...
appendices](/v1.19/appendices/#identifier-grammar) for full details of the
...
about this is described in the deprecation policy[deprecation policy](/v1.19/#deprecation-policy)
below.
...
`GET /_matrix/client/versions`[GET /_matrix/client/versions](/v1.19/client-server-api/#get_matrixclientversions)
response.
