...
This room version builds on version 6[version 6](/v1.19/rooms/v6/) to introduce knocking
...
redaction algorithm locally should refer to the redactions[redactions](/v1.19/rooms/v7/#redactions)
...
Room version 6[Room version 6](/v1.19/rooms/v6/) has details of other authorisation rule changes,
as do the versions v6 is based upon.

### Authorisation rules

**[New in this version]** For checks performed upon `m.room.member` events, a
...
the Handling redactions[Handling redactions](/v1.19/rooms/v7/#handling-redactions) section.
