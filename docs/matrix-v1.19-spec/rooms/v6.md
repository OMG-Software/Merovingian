...
This room version builds on version 5[version 5](/v1.19/rooms/v5/) while changing various
...
redactions[redactions](/v1.19/rooms/v6/#redactions) section below for a full overview of the algorithm.

### Redactions

**[New in this version]** All significant meaning for `m.room.aliases`
...
- `m.room.member`[m.room.member](/v1.19/client-server-api/#mroommember) allows key `membership`.

- `m.room.create`[m.room.create](/v1.19/client-server-api/#mroomcreate) allows key `creator`.

- `m.room.join_rules`[m.room.join_rules](/v1.19/client-server-api/#mroomjoin_rules) allows key `join_rule`.
...
- `m.room.history_visibility`[m.room.history_visibility](/v1.19/client-server-api/#mroomhistory_visibility) allows
...
in room version 5[room version 5](/v1.19/rooms/v5/).

### Redactions

See above[See above](/v1.19/rooms/v6/#redactions).

### Event format

**[New in this version]** Through enforcement of Canonical JSON[Canonical JSON](/v1.19/rooms/v6/#canonical-json),
...
**[New in this version]** Rule 4, which related specifically to events
of type `m.room.aliases`, is removed. `m.room.aliases` events must still pass
authorisation checks relating to state events.

**[New in this version]** Additionally, the authorisation rules for events of
...
the Handling Redactions[Handling Redactions](/v1.19/rooms/v6/#handling-redactions) section.
...
`m.room.power_levels`[m.room.power_levels](/v1.19/client-server-api/#mroompower_levels) events can
