...
This room version builds on version 8[version 8](/v1.19/rooms/v8/) to add additional redaction
rules that were unintentionally missed when incorporating v8.

## Client considerations

See room version 8[room version 8](/v1.19/rooms/v8/) for specific details regarding the addition of
restricted rooms.

Clients which implement the redaction algorithm locally should refer to the
redactions[redactions](/v1.19/rooms/v9/#redactions) section below for a full overview.

### Redactions

**[New in this version]** `m.room.member`[m.room.member](/v1.19/client-server-api/#mroommember) events
...
Issue #3373[Issue #3373](https://github.com/matrix-org/matrix-doc/issues/3373) has further
information.
...
See above[See above](/v1.19/rooms/v9/#redactions).
...
the Handling RedactionsHandling Redactions section.
