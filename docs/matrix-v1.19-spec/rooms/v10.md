...
This room version builds on version 9[version 9](/v1.19/rooms/v9/) to enforce that power level
...
members of a room join either through knocking (introduced in room version 7[room version 7](/v1.19/rooms/v7/))
or through “join restrictions” (introduced in room version 8[room version 8](/v1.19/rooms/v8/) and
refined in room version 9[room version 9](/v1.19/rooms/v9/)).
...
redactions[redactions](/v1.19/rooms/v10/#redactions) section below for a full overview.
...
Room version 7[Room version 7](/v1.19/rooms/v7/) added “knocking” and room version 8[room version 8](/v1.19/rooms/v8/)
added “join restrictions” (refined by room version 9[room version 9](/v1.19/rooms/v9/)) — both allow
...
The event format is unchanged by this room version. See below[below](/v1.19/rooms/v10/#event-format-1)
...
In other room versions, such as v9[v9](/v1.19/rooms/v9/#mroompower_levels-events-accept-values-as-strings),
...
the Handling redactions[Handling redactions](/v1.19/rooms/v10/#handling-redactions) section.
...
- `m.room.member`[m.room.member](/v1.19/client-server-api/#mroommember) allows keys `membership`,
`join_authorised_via_users_server`.

- `m.room.create`[m.room.create](/v1.19/client-server-api/#mroomcreate) allows key `creator`.

- `m.room.join_rules`[m.room.join_rules](/v1.19/client-server-api/#mroomjoin_rules) allows keys `join_rule`,
`allow`.
