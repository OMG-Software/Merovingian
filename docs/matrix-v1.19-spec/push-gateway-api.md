...
Module[Push
Module](/v1.19/client-server-api/#push-notifications).
...
`/_matrix/client/v3/pushers/set`[/_matrix/client/v3/pushers/set](/v1.19/client-server-api/#post_matrixclientv3pushersset).| Rate-limited: | No |
| --- | --- |
...
| `data` | `PusherDataPusherData` | A dictionary of additional pusher-specific data. This is the `data` dictionary passed in at pusher creation[pusher creation](/v1.19/client-server-api/#post_matrixclientv3pushersset) minus the `url` key. |
