...
packages="build-essential clang lld python3 python3-venv pkg-config git perl bison flex m4 libssl-dev libsodium-dev libpq-dev catch2 clang-format clang-tidy cppcheck"
