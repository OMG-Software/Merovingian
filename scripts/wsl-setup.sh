...
packages="build-essential clang lld python3 python3-venv pkg-config git libsodium-dev libpq-dev libsqlite3-dev libssl-dev catch2 clang-format clang-tidy cppcheck"
