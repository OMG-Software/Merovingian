...
# Build an OpenBSD binary package (.tgz) for merovingian 0.10.10.
#
# Standalone pkg_create(1) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no ports tree. The checked-in packaging/openbsd/PLIST
